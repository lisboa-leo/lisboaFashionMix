          ...
          <Tab.Content>
                    ...
                    <tbody>
                      {vendas.map((venda, index) => (
                        <tr key={index} className="align-middle border-top">
                          ...
                          <td className="text-center small">
                            R${" "}
                            {(venda.valorTotal / venda.quantidade).toFixed(2)}
                          </td>
                        </tr>
                      ))}
                    </tbody>
            ...
            <Tab.Pane eventKey="produtos">
              <Card className="shadow-sm">
                <Card.Body>
                  <h5 className="fw-bold">Relatório produtos</h5>
                  <p>Fluxo de caixa, receitas, despesas e saldo mensal.</p>
                </Card.Body>
              </Card>
            </Tab.Pane>
            ...
            <Tab.Pane eventKey="clientes">
              <Card className="shadow-sm">
                <Card.Body>
                  <h5 className="fw-bold">Relatório de clientes</h5>
                  <p>
                    Produtos em estoque, quantidade mínima e status de
                    reposição.
                  </p>
                </Card.Body>
              </Card>
